...
public class OrderHelper {
    ...
    public JSONObject create(Order order) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "INSERT INTO `sa`.`orders`(`phoneNumber_Member`, `stateOforder`, `dateOforder`, `id_Member`)"
                    + " VALUES(?, ?, ?, ?)";
            ...
            Timestamp date_of_order = order.getTime();
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa`.`orders`";
            ...
            while(rs.next()) {
                ...
                String phone_number = rs.getString("phoneNumber_Member");
                //String name = rs.getString("name");
                String state_of_order = rs.getString("stateOforder");
                Timestamp date_of_order = rs.getTimestamp("dateOforder");
                String sn_Coupon = rs.getString("sn_Coupon");
                /** 將每一筆商品資料產生一名新Product物件 */
                o = new Order(id, id_Member,phone_number, date_of_order, state_of_order,sn_Coupon);
    ...
    public JSONObject getById(String order_id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa`.`orders` WHERE `orders`.`id` = ?";
            ...
            while(rs.next()) {
                ...
                String sn_Coupon = rs.getString("sn_Coupon");
                String stateOforder= rs.getString("stateOforder");  
                Timestamp dateOforder = rs.getTimestamp("dateOforder");
                
                /** 將每一筆商品資料產生一名新Product物件 */
                o = new Order(id, id_Member,phoneNumber_Member , dateOforder, stateOforder,sn_Coupon);
                /** 取出該項商品之資料並封裝至 JSONsonArray 內 */
               // data = o.getOrderAllInfo();
                jsa.put(o.getOrderAllInfo());
            }
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `sa`.`orders` WHERE `id` = ? LIMIT 1";
    ...
    public JSONObject update(Order o) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa`.`orders` SET `stateOforder` = ?  WHERE `id` = ?";
            /** 取得所需之參數 */
