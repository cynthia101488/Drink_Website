...
public class OrderDetail {
    ...
    public OrderDetail(int id, int quantity_Product) {
    	this.id = id;      
        this.quantity_Product = quantity_Product;
    }
    ...
    public OrderDetail(Product pd, int quantity_Product, String specification,String id_Cup, int quantity_Cup, int price_Coupon ) {
        this.pd = pd;
        this.quantity_Product = quantity_Product;
    ...
    public OrderDetail(int orderdetail_id, int id_Order, int id_Product, String specification, int quantity_Product,
    		int price_Product, String id_Cup, int quantity_Cup, int price_Cup, int price_Coupon ) {
    ...
    public OrderDetail(int id,int id_Order,int id_Product, String specification_Product, int quantity_Product, String id_Cup) {
    	this.id = id;
        this.id_Order = id_Order;
        this.id_Product = id_Product;
        this.specification_Product = specification_Product;
        this.quantity_Product = quantity_Product;
        this.id_Cup = id_Cup;
        getProductFromDB(id_Product);
    }
    ...
    public JSONObject getOrderData() {
        JSONObject jso = new JSONObject();
        jso.put("id", getId());
        jso.put("product", getProduct().getData());
        jso.put("specification_Product",  getSpecification());
        jso.put("price_Product", getPrice_Product());
        jso.put("quantity_Product", getQuantity_Product());
        jso.put("id_Cup", getId_Cup());
        jso.put("id_Order", getId_Order());
        jso.put("price_Cup", getPrice_Cup());
