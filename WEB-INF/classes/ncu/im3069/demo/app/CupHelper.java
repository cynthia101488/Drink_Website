...
public class CupHelper {
    ...
    public JSONObject getByIdList(String data) {
      ...
      try {
          ...
          /** SQL指令 */
          String sql = "SELECT * FROM `sa`.`cup` WHERE `cup`.`id`";
    ...
    public JSONObject update(Cup c) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa`.`cup` SET `name` = ? ,`image` = ? , `price` = ? , `quantity` = ? WHERE `id` = ?";
            /** 取得所需之參數 */
            int id = c.getID();
    ...
    public JSONObject getById(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa`.`cup` WHERE `cup`.`id` = ? LIMIT 1";
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `sa`.`cup` WHERE `id` = ? LIMIT 1";
    ...
    public JSONObject create(Cup c) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `sa`.`cup`( `name`, `image`, `price`, `quantity`)"
                    + " VALUES( ?, ?, ?, ?)";
