...
public class ProductHelper {
    ...
    public JSONObject update(Product p) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa`.`products` SET name = ? ,`price` = ? , image = ? , description = ? WHERE id = ?";
            /** 取得所需之參數 */
            int id = p.getID();
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa`.`products`";
    ...
    public boolean checkDuplicate(Product p){
 ...
 ResultSet rs = null;
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `sa`.`products` WHERE name = ?";
    ...
    public JSONObject create(Product p) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `sa`.`products`(`name`, `price`, `image`, `description`)"
                    + " VALUES(?, ?, ?, ?)";
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `sa`.`products` WHERE id = ? LIMIT 1";
