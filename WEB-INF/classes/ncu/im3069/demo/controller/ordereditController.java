...
public class ordereditController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!id.isEmpty()) {
          ...
          JSONObject query = odh.getByEId(id);
          resp.put("status", "200");
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
            ...
            int quantity_Product = jso.getInt("quantity_Product");
            
            /** 透過傳入之參數，新建一個以這些參數之會員Member物件 */
            OrderDetail od  = new OrderDetail(id, quantity_Product);
            
            /** 透過Member物件的update()方法至資料庫更新該名會員資料，回傳之資料為JSONObject物件 */
            JSONObject data = od.update();
